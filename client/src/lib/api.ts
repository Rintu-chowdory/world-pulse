...
const API_BASE = (import.meta.env.VITE_API_BASE || "https://world-pulse-api.onrender.com").replace(/\/$/, "");
...
> = {
  earthquake: { label: "Quakes", icon: "◒", color: "#ff9f40" },
  wildfire: { label: "Fires", icon: "⌁", color: "#ff4557" },
  flood: { label: "Floods", icon: "≋", color: "#3e9bff" },
  storm: { label: "Storms", icon: "⟋", color: "#ffd23f" },
  volcano: { label: "Volcanoes", icon: "△", color: "#ff6b3d" },
};
